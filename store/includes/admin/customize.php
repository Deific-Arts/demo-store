...
Class Customize {
  ...
  public function __construct() {
    add_action('customize_register', array(get_class(), 'add_site'));
    add_action('customize_register', array(get_class(), 'add_information'));
    add_action('customize_register', array(get_class(), 'add_locations'));
    add_action('customize_register', array(get_class(), 'add_social_media'));
  }
