...
Class PostTypes {
  public static function init() {
    add_action('init', array(get_class(), 'add_masthead'));
  }

  public static function add_masthead() {
    $labels = array(
      'name'          => 'Masthead', // Plural name
      'singular_name' => 'Masthead'   // Singular name
    );
    ...
    $args = array(
      'labels'              => $labels,
      'description'         => 'masthead on the homepage.', // Description
      'supports'            => $supports,
